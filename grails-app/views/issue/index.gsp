...
<html>
    ...
    <body>
        ...
        <div id="list-issue" class="content scaffold-list" role="main">
            ...
            <f:table class="table" collection="${issueList}" properties="name, createdBy, createdDate, numberOfComments, numberOfUpvotes, numberOfDownvotes"/>

            <g:if test="${issueCount > 10}">
